...
The dataset used in this analysis is the “Supermarket Sale” dataset. The dataset contains information about supermarket transactions, including customer type, product category, quantity sold, and total sales amount. The dataset contains approximately 251 rows and 8 columns. This dataset is useful for analysing sales performance and customer purchasing behaviour.
